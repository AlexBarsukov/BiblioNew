package com.work.retailapp.domain.mock;

import com.work.retailapp.model.CenterRepository;
import com.work.retailapp.model.entities.Product;
import com.work.retailapp.model.entities.ProductCategoryModel;
...
public class FakeWebServer {
    ...
    public void addCategory() {
        ...
        listOfCategory
                .add(new ProductCategoryModel(
                        "Бытовая техника",
                        "Телевизоры, микроволновые печи и прочее",
                        "10%",
    ...
    public void getAllElectronics() {
        ...
        productMap.put("Микроволновые печи", productlist);
        ...
        productMap.put("Телевизоры", tvList);
        ...
        productMap.put("Пылесосы", productlist);
    ...
    public void getAllFurnitures() {
        ...
        productMap.put("Столы", productlist);
        ...
        productMap.put("Кресла", productlist);
        ...
        productMap.put("Гардероб", productlist);
